...
export function CreateAdBanner() {
    return (
        <div 
          className='relative bg-[#2A2634] px-8 py-6 mt-8 self-stretch rounded-lg overflow-hidden before:content-[""] before:w-full before:h-1 before:bg-nlw-gradient before:absolute before:left-0 before:top-0 flex justify-between items-center'
        >
        <div>
